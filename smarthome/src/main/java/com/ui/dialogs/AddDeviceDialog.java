    ...
    private SmartDevice createDevice() {
        ...
        try {
            return switch (deviceType) {
                ...
                case "SecurityCamera" -> new SecurityCamera(deviceId, deviceName, "1080p", 120, energyMode); // Default 1080p, 120° FOV
                ...
                case "DoorWindowSensor" -> new DoorWindowSensor(deviceId, deviceName, "Room", energyMode); // Default location
