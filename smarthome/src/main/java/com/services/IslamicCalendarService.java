...
public class IslamicCalendarService {
    ...
    private static String getIslamicEvent(String month, String day) {
        ...
        switch (monthDayKey) {
            ...
            case "1-1": return "Islamic New Year";
            case "9-1": return "Ramadan Begins";
            case "9-27": return "Laylat al-Qadr";
            case "3-12": return "Mawlid al-Nabi";
            case "7-27": return "Isra and Mi'raj";
            default: return null;
        }
    }
    ...
    private static String getMonthNumber(String monthEn) {
        switch (monthEn.toLowerCase()) {
            ...
            case "safar": return "2";
            case "rabi al-awwal": return "3";
            case "rabi al-thani": return "4";
            case "jumada al-awwal": return "5";
            case "jumada al-thani": return "6";
            case "rajab": return "7";
            case "sha'ban": return "8";
            case "ramadan": return "9";
            case "shawwal": return "10";
            case "dhu al-qidah": return "11";
            case "dhu al-hijjah": return "12";
            default: return "0";
        }
    }
