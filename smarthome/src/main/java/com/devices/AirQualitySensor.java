...
import com.interfaces.AirQualityMonitor;
...
public class AirQualitySensor extends SmartDevice implements Controllable, AirQualityMonitor {
    ...
    public AirQualitySensor(String deviceId, String name, EnergyMode energyMode) {
    ...
    public double getEnergyConsumption() {
        if (!isOn) return 0.5; // Standby power
        
        double baseConsumption = 3.0; // Base consumption when active
